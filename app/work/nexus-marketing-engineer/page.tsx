...
const SLUG = "nexus-marketing-engineer";
...
export default function NexusMarketingEngineerCaseStudy() {
  const work = works.find((w) => w.slug === SLUG)!;
        ...
        <article className="pt-32 md:pt-40 pb-24 md:pb-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <Section eyebrow="01 · The Proposition" title="A content system, not a content service.">
              <p>
                Most marketing partners ship deliverables. A marketing engineer ships
                a system that ships deliverables. The pitch for Nexus / Terpene Belt
            ...
            >
              ...
              <p className="mt-6 text-sm text-[color:var(--muted)]">
                The full Voice Manual sits in the brain and reloads before every draft.
                Every agent gets a copy. Every output is checkable against it.
              </p>
            </Section>
            ...
            >
              <p>
                ...
                California state-funded cannabis research grant, with TBF supplying the
                native-terpene input dataset. Below: the four drafts the system would
                produce from that single news input. None of these were hand-tuned for
                tone. The Voice Manual carries the brand voice.
              </p>
                  ...
                  body={
                    <>
                      <p className="text-sm">
                        ...
                        A new dataset on full-spectrum terpene behavior in vape carts
                      </p>
